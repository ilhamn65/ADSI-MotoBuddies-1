...
class ServiceController extends Controller
{
    ...
    //     $service7->nama = "Tune_Up";
    //     $service7->harga = 3000000;
    //     $service7->deskripsi = "Servis tune up mobil adalah kegiatan penyetelan ulang semua komponen, durasi pengerjaan cukup lama namun tidak sesering servis mobil. Montir akan mengecek lebih jauh komponen-komponen mobilmu";
